        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <button 
                 ...
                 Edit
                    ...
                    <a href='?delete={$row['MemberID']}' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure?\")'>Delete</a>
                </td>
            </tr>";
        }
        ?>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <!-- <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="amountEdit" name="amountEdit" required>
                        <br>
                        <p>Silver: 50</p>
                        <p>Gold: 100</p>
